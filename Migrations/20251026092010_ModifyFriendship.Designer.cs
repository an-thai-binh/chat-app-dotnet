...
namespace ChatAppApi.Migrations
{
    ...
    [Migration("20251026092010_ModifyFriendship")]
    partial class ModifyFriendship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChatAppApi.Models.Friendship", b =>
                {
                    ...
                    b.Property<long?>("PrivateConversationId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ChatAppApi.Models.Friendship", b =>
                {
                    ...
                    b.HasOne("ChatAppApi.Models.Conversation", "PrivateConversation")
                        .WithOne("Friendship")
                        .HasForeignKey("ChatAppApi.Models.Friendship", "PrivateConversationId");
